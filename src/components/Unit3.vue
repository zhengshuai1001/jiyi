...
export default {
  ...
  mounted() {
    ...
    this.handleClientWidth(document.documentElement.clientWidth);
    // window.onresize = () => {
    //   this.clientWidth = document.documentElement.clientWidth;
    //   this.clientHeight = document.documentElement.clientHeight;
    // }
  ...
  methods: {
    ...
    handleClientWidth(val) {
      ...
      // }
      if (val < 800) {
        this.setPageScale(val, 800);
      } else if (val >= 80 && val <= 1900) {
        if (this.clientHeight > 559) {
          this.unitPageScale = 1;
        }
      } else {
